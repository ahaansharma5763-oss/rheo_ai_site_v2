...
export default function WaveSystem({ intensity = 'hero', className = '', style }: WaveSystemProps) {
  ...
  const layers = intensity === 'hero' ? [
    ...
    { color: '#1A1A1A', opacity: 0.5,  duration: 38, path: 'M0,180 C120,100 240,260 360,150 C480,40 600,220 720,130 C840,40 960,200 1080,110 C1200,20 1320,160 1440,90 L1440,420 L0,420 Z' },
    { color: '#1A1A1A', opacity: 0.65, duration: 30, path: 'M0,200 C150,110 300,280 450,160 C600,40 750,240 900,140 C1050,40 1200,210 1440,120 L1440,420 L0,420 Z' },
    ...
    { color: '#111111', opacity: 0.8,  duration: 17, path: 'M0,260 C200,150 400,330 600,210 C800,90 1000,290 1200,180 C1360,100 1420,250 1440,190 L1440,420 L0,420 Z' },
    ...
    { color: '#1A1A1A', opacity: 0.5,  duration: 32, path: 'M0,100 C120,50 240,160 360,90 C480,20 600,130 720,70 C840,10 960,120 1080,60 C1200,10 1320,90 1440,50 L1440,260 L0,260 Z' },
    ...
    { color: '#111111', opacity: 0.8,  duration: 16, path: 'M0,145 C200,80 400,190 600,120 C800,50 1000,170 1200,105 C1360,55 1420,145 1440,110 L1440,260 L0,260 Z' },
    ...
    { color: '#1A1A1A', opacity: 0.55, duration: 28, path: 'M0,50 C120,20 240,80 360,45 C480,10 600,65 720,35 C840,5 960,60 1080,30 C1200,5 1320,50 1440,25 L1440,140 L0,140 Z' },
    { color: '#111111', opacity: 0.8,  duration: 18, path: 'M0,65 C180,30 360,90 540,55 C720,20 900,80 1080,45 C1260,15 1380,70 1440,45 L1440,140 L0,140 Z' },
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 1440 420" style={{ position:'absolute',bottom:0,left:0,width:'100%',height:'100%' }} preserveAspectRatio="xMidYMax slice">
        <polygon points="560,420 720,100 880,420" fill="#1A1A1A" opacity="0.07"/>
        <polygon points="540,420 720,75 900,420"  fill="#1A1A1A" opacity="0.04"/>
        {/* Snow cap */}
