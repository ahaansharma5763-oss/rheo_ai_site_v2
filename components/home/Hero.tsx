    ...
    <section style={{
      ...
      <div aria-hidden style={{
        ...
        <div style={{
          ...
          <HeroDithering colorBack="#0B2147" colorFront="#3FAEDE" shape="wave" type="4x4" speed={0.32} />
        </div>
      </div>
      ...
      <div style={{ maxWidth: 'var(--container-max)', width: '100%', margin: '0 auto', position: 'relative', zIndex: 2 }}>
        ...
        <Reveal delay={250}>
          <h1 className="gold-shimmer" style={{
            ...
            maxWidth: '18ch',
            marginBottom: '48px',
            filter: 'drop-shadow(0 2px 24px rgba(255,223,143,0.18))',
          }}>
        ...
        <Reveal delay={650}>
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            <a
              ...
              onMouseEnter={e => {
                e.currentTarget.style.boxShadow = '0 0 40px rgba(255,223,143,0.32)';
