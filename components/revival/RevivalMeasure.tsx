...
const RECEIPTS = [
  { title: 'Every booking carries a tag', body: 'Each conversation Nami starts is tagged to the campaign. A booking without the tag is never claimed as ours. "They would have come anyway" gets settled by the tag, not by argument.' },
