      ...
      <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <Reveal delay={140}>
          <h2 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(30px, 4.4vw, 54px)', lineHeight: 1.14, letterSpacing: '-0.02em', color: 'var(--fg)', fontWeight: 500, maxWidth: '24ch', marginBottom: '28px' }}>
            The Sprint is one campaign. Pulse makes it permanent<span style={{ color: 'var(--gold)' }}>.</span>
          </h2>
        </Reveal>
        ...
        <Reveal delay={240}>
          <p style={{ fontFamily: 'var(--sans)', fontSize: 'clamp(15px, 1.4vw, 17.5px)', lineHeight: 1.8, color: 'var(--fg-mute)', fontWeight: 300, maxWidth: '68ch', marginBottom: '36px' }}>
            The Sprint proves, in three weeks, what follow-up is worth to your business. Pulse is what happens
            ...
            back. Most businesses run the Sprint, see the number, and never want to go without it again.
          </p>
        </Reveal>
