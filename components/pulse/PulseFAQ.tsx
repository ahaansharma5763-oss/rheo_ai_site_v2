...
const FAQS: QA[] = [
  ...
  { q: 'What if I already have Ava?', a: 'Then you are already ahead. Ava and Pulse are designed to work as one system. Ava handles the first conversation, Pulse handles the entire journey around it. Running both closes the loop completely.' },
