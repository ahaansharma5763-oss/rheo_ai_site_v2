...
const FAQS: QA[] = [
  ...
  { q: 'What if I already run Metis?', a: 'Then you are already ahead. Metis, our AI Sales Engineer, and Pulse are designed to work as one system. Metis handles the first conversation, Pulse handles the entire journey around it. Running both closes the loop completely.' },
