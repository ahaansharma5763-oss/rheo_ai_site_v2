...
const CASES: UseCase[] = [
  { icon: 'refresh',      title: 'Revives your dead leads',        description: 'On day one, Okeanos goes through months of cold leads and reopens conversations with a fresh reason to talk. This alone often pays for the entire system.' },
  { icon: 'bolt',         title: 'Catches ready buyers instantly', description: 'The second someone signals they are ready, Okeanos moves them toward the close and alerts you in real time. No more “saw it too late.”' },
  { icon: 'clock',        title: 'Rescues the abandoned ones',     description: 'Someone asked about booking and then disappeared. Okeanos notices within the hour and brings them back before the moment passes.' },
  { icon: 'chat',         title: 'Handles the hesitations',        description: 'Price worries, timing worries, “I need to ask my partner.” Okeanos responds to each the right way, in your voice, instead of letting them end the conversation.' },
  { icon: 'users',        title: 'Wins back past customers',       description: 'Okeanos stays in touch with people who already bought and brings them back when the time is right. The cheapest customer to win is the one who already trusts you.' },
  { icon: 'shield',       title: 'Protects your best relationships', description: 'For ongoing clients, Okeanos watches for the quiet signs that someone is drifting away and flags it while you can still do something about it.' },
];
...
export default function PulseUseCases() {
  return (
    <section style={{ padding: 'var(--section-gap) var(--rail-pad)', position: 'relative', overflow: 'hidden', borderTop: '1px solid rgba(46,116,172,0.12)' }}>
      <WaveField variant="corner-left" shape="simplex" colorFront="#2E74AC" opacity={0.34} speed={0.26} />

      <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <Reveal>
          <span className="eyebrow" style={{ display: 'block', marginBottom: '20px', color: 'var(--gold-end)' }}>
            What Okeanos does, in plain terms
          </span>
        </Reveal>
