...
const PILLARS: Pillar[] = [
  {
    ...
    body: 'Pulse goes back through every lead you have ever spoken to and brings the right ones back to life — then makes sure no new lead ever slips through again. You are not buying software. You are buying the customers you already paid to find and never closed.',
  ...
  },
  {
    ...
    body: 'Good follow-up means someone remembering who said what, when to circle back, and what to say. That is hours every week, and it still misses people. Pulse carries all of it, so your team only ever talks to people who are already warm.',
  ...
  },
  {
    ...
    body: 'Nothing to learn, nothing to log into every morning, nothing to manage. Pulse brings the important moments to you — a hot-lead alert when someone is ready to buy, a heads-up when a good customer is slipping away. The rest, it simply handles.',
