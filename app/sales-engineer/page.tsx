...
export const metadata = {
  title: 'The AI Sales Engineer for Industrial Companies | Rheo AI',
  description: 'For manufacturers and distributors of technical products. It qualifies buyers, recommends the right machine from your real catalogue, and sends exact, cited quotes in minutes. In any language, on any channel, around the clock. Live in under 3 weeks with a 60-day pay-for-itself guarantee.',
}
